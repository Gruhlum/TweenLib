...
namespace HexTecGames.TweenLib
{
    ...
    {
        public static IEnumerator Fade(CanvasGroup canvasGroup, float duration, float start, float end, EaseFunction easing)
        {
            float timer = 0;
        ...
        public static IEnumerator LerpColor(Image target, float duration, Color start, Color end, EaseFunction easing)
        {
            float timer = 0;
            while (timer < duration)
            {
        ...
        public static IEnumerator LerpColor(SpriteRenderer target, float duration, Color start, Color end, EaseFunction easing)
        {
            float timer = 0;
            while (timer < duration)
            {
        ...
        public static IEnumerator Fade(Image target, float duration, float startAlpha, float endAlpha)
        {
            yield return LerpColor(target, duration, target.color.GetColorWithAlpha(startAlpha), target.color.GetColorWithAlpha(endAlpha));
        }
        public static IEnumerator Fade(SpriteRenderer target, float duration, float startAlpha, float endAlpha)
        {
            yield return LerpColor(target, duration, target.color.GetColorWithAlpha(startAlpha), target.color.GetColorWithAlpha(endAlpha));
        }


        public static IEnumerator Fade(Image target, float duration, float startAlpha, float endAlpha, EaseFunction easing)
        {
        ...
        public static IEnumerator Fade(SpriteRenderer target, float duration, float startAlpha, float endAlpha, EaseFunction easing)
        {
            yield return LerpColor(target, duration, target.color.GetColorWithAlpha(startAlpha), target.color.GetColorWithAlpha(endAlpha), easing);
        }
